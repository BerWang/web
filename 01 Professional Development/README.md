...
## GitHub
You are required to maintain your code on the University GitHub repository at github.coventry.ac.uk where you will be added to the module organisation. For this to happen you will need to have logged in in order to generate your profile. The first task is to **log in using your University credentials** and notify your lab tutors if you can't do this.
